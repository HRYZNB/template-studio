...
TEMPLATE_AUTHORING_REGISTRY = TemplateAuthoringRegistry(
    ...
    geometryPrototypes=[
        ...
        GeometryPrototypeOption(id="prototype.openThinWallProfile", label="开口薄壁截面", description="以连续中心线加厚度表达 C、Ω、帽形等薄壁截面。", constructionMode="coldRollForming", previewStrategy="openProfile", operator="sketch.centerline_thinwall_extrude", drivingParameters=["length", "sectionWidth", "sectionHeight", "thickness"], implementationStatus="available"),
