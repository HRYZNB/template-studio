...
TEMPLATE_AUTHORING_REGISTRY = TemplateAuthoringRegistry(
    ...
    geometryPrototypes=[
        GeometryPrototypeOption(id="prototype.customRecipe", label="通用二维参数化截面", description="从可编辑图元、尺寸、约束和截面区域开始，不限定零部件形状。", constructionMode="extrude", operator="sketch.region_extrude", drivingParameters=["length", "sectionWidth", "sectionHeight"], implementationStatus="available"),
        GeometryPrototypeOption(id="prototype.plate", label="板类／平面轮廓", description="用通用二维草图建立实心或带孔平面轮廓。", constructionMode="extrude", previewStrategy="plate", operator="sketch.region_extrude", drivingParameters=["length", "sectionWidth", "sectionHeight"], implementationStatus="available"),
        GeometryPrototypeOption(id="prototype.openThinWallProfile", label="开口薄壁截面", description="以草图中心线偏移生成薄壁轮廓，再区域拉伸成实体。", constructionMode="coldRollForming", previewStrategy="openProfile", operator="sketch.region_extrude", drivingParameters=["length", "sectionWidth", "sectionHeight", "thickness"], implementationStatus="available"),
        GeometryPrototypeOption(id="prototype.closedProfile", label="闭口／管类截面", description="使用外环加内环减材表达矩形管和任意多腔截面。", constructionMode="extrude", previewStrategy="closedProfile", operator="sketch.region_extrude", drivingParameters=["length", "sectionWidth", "sectionHeight", "thickness"], implementationStatus="available"),
